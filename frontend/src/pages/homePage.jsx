        ...
        >
          ...
          <Container className="position-relative z-2">
            <div className="banner-content-wrapper text-start">
              ...
              >
                TÌM QUẦN ÁO <br /> PHÙ HỢP <br /> PHONG CÁCH CỦA BẠN
              </h1>
              <p className="banner-description mt-3 fs-5">
                Khám phá bộ sưu tập đa dạng, <br /> được chăm chút tỉ mỉ để tôn vinh nét riêng và phong cách của bạn.
              </p>
              ...
              <Row className="stats-row stats-row-custom mt-5">
                <Col xs={4} className="text-center">
                  ...
                  <small className="stat-label">Thương hiệu quốc tế</small>
                </Col>
                <Col xs={4} className="text-center">
                  <h5 className="fw-bold stat-number">2,000+</h5>
                  <small className="stat-label">Hàng chất lượng cao</small>
                </Col>
                <Col xs={4} className="text-center">
                  <h5 className="fw-bold stat-number">30,000+</h5>
                  <small className="stat-label">Khách hàng hài lòng</small>
                </Col>
              </Row>
        ...
        <section className="testimonial-section py-5">
          <Container>
            <div className="section-header text-center mb-4">
              <h2 className="fw-bold">Đánh giá</h2>
            </div>
            <Row className="justify-content-center">
              <Col md={4} className="mb-4">
                <Card className="h-100 p-3 shadow-sm border">
                  <div className="d-flex align-items-center mb-2">
                    <h5 className="mb-0 fw-bold">Lol. Anh Bảo</h5>
                  ...
                  <p className="mb-0">
                    "Tôi thực sự ấn tượng với chất lượng và phong cách của những bộ quần áo nhận từ shop. Từ đồ mặc thường ngày đến váy dạ hội sang trọng, mọi món tôi mua đều vượt xa mong đợi."
                  </p>
                </Card>
              </Col>
              <Col md={4} className="mb-4">
                <Card className="h-100 p-3 shadow-sm border">
                  <div className="d-flex align-items-center mb-2">
                    <h5 className="mb-0 fw-bold">Bành. Minh Ngoặc</h5>
                  </div>
                  <div className="text-warning mb-2">
                    ★★★★★
                  </div>
                  <p className="mb-0">
                    "Trước đây việc tìm quần áo hợp với phong cách cá nhân của tôi là một thách thức, cho đến khi tôi biết đến TNBHStore."
                  </p>
                </Card>
              </Col>
              <Col md={4} className="mb-4">
                <Card className="h-100 p-3 shadow-sm border">
                  <div className="d-flex align-items-center mb-2">
                    <h5 className="mb-0 fw-bold">Thờ I Thy</h5>
                    <i className="fas fa-check-circle text-success ms-2"></i>
                  </div>
                  <div className="text-warning mb-2">
                    ★★★★★
                  ...
                  <p className="mb-0">
                    "Là người luôn tìm kiếm những món thời trang độc đáo, tôi rất vui khi tình cờ khám phá ra TNBHStore."
                  </p>
                </Card>
              </Col>
            </Row>
            ...
            <Row className="justify-content-center text-center">
              <Col lg={8}>
                <h3 className="fw-bold text-uppercase">
                 Cập nhật thường xuyên các ưu đãi mới nhất của chúng tôi
                </h3>
