...
# Redis configuration - tương thích với cả local và production
...
# Database configuration - tương thích với cả local và production
if os.getenv('DATABASE_URL'):
    # Production: PostgreSQL via DATABASE_URL (như Render)
    DATABASES = {
